    ...
    return (
      ...
      >
        ...
        >
          ...
          {institution?.address && (
            <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '4px', marginTop: '1px', fontFamily: "'Hind Siliguri', sans-serif" }}>
              {institution.address}
            </div>
          )}
          <div
        ...
        >
          ...
          <div style={{ textAlign: 'center', maxWidth: '55px' }}>
            ...
            <div style={{ fontSize: '4.5px', color: 'rgba(255,255,255,0.8)', fontFamily: "'Hind Siliguri', sans-serif" }}>
