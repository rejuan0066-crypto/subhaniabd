    ...
    <AdminLayoutNestingContext.Provider value>
      <div className="min-h-screen flex bg-background">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Top bar */}
          <header className={`bg-card border-b px-4 lg:px-6 ${headerPadClass} flex items-center justify-between sticky top-0 z-40 shrink-0`} style={{ ...headerStyle, fontSize: 'var(--header-font-size, 13px)' }}>
