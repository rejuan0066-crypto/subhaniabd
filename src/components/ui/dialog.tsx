...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-semibold leading-none tracking-tight text-3xl text-center bg-primary text-primary-foreground my-[35px] mx-[2px] px-0 border border-primary", className)}
    {...props}
  />
));
