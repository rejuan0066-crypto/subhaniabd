...
<head>
  ...
  <style>@font-face{font-family:"Kalpurush";src:url("https://cdn.jsdelivr.net/gh/maateen/bangla-web-fonts/fonts/kalpurush/kalpurush.woff2") format("woff2"),url("https://cdn.jsdelivr.net/gh/maateen/bangla-web-fonts/fonts/kalpurush/kalpurush.woff") format("woff");font-display:swap;}@font-face{font-family:"SolaimanLipi";src:url("https://cdn.jsdelivr.net/gh/maateen/bangla-web-fonts/fonts/SolaimanLipi/SolaimanLipi.woff2") format("woff2"),url("https://cdn.jsdelivr.net/gh/maateen/bangla-web-fonts/fonts/SolaimanLipi/SolaimanLipi.woff") format("woff");font-display:swap;}</style><link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Bengali:wght@400;500;600;700&family=Hind+Siliguri:wght@400;500;600;700&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet" />
  <style>
    @page {
      size: 54mm 86mm;
      margin: 0;
